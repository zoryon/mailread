...
urlpatterns = [
    ...
    path('api/mail/', views.MailListView.as_view(), name='mail_list'),
    path('api/mail/status/', views.MailStatusView.as_view(), name='mail_status'),
    path('api/mail/<str:uid>/', views.MailDetailView.as_view(), name='mail_detail'),
